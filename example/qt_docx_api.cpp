...
//Colors
const QString textDocx::R="FF0000";
const QString textDocx::G="00FF00";
const QString textDocx::B="0000FF";
...
//==============================================
// Implementaciones de métodos tableDocx
//==============================================
...
//==============================================
const bool headerFooterDocx::TEXT = true;
const bool headerFooterDocx::IMAGE = false;
...
//==============================================
// Implementaciones de métodos writerDocx
//==============================================
...
void writerDocx::writeImageFrom(imageDocx image, QDomElement tagAnterior) {
    ...
    QString width = QString::number( image.getWidth() );
